...
//
//	GLuint woodTexture = loadTexture("Images/wall1.jpg");
//
//	GLuint diffuseMap = loadTexture("Images/bricks2.jpg");
//	GLuint normalMap = loadTexture("Images/bricks2_normal.jpg");
//	GLuint heightMap = loadTexture("Images/bricks2_disp.jpg");
//
//	ImGui::CreateContext();
//	IMGUI_CHECKVERSION();
...
//	//heightmap
//	heightmapShader.use();
//	heightmapShader.setInt("diffuseMap", 0);
//	heightmapShader.setInt("normalMap", 1);
//	heightmapShader.setInt("depthMap", 2);
//
...
//		heightmapShader.setFloat("heightScale", heightScale); // adjust with Q and E keys
//		glActiveTexture(GL_TEXTURE0);
...
//
//			ImGui::SliderFloat("Height Scale", &heightScale, -10, 10);// Edit 1 float using a slider from 0.0f to 1.0f
//
//			ImGui::End();
//		}
//
